			...
			$.ajax({
				...
				success:function(data){
						if (data.success) {
							//清空文本域中的数据
							$("#remark").val("");
							//若添加成功，则json中的数据为：  json:{success:true/false,remark:remark对象}
							//添加备注成功，则添加一个div
							var html="";
							...
							/*当没有修改的时候，使用的时间为创建时间，使用的名称为创建人名称*/
